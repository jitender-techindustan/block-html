...
function Html({ style, props }) {
  ...
  if (!children) {
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: cssStyle });
  }
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: cssStyle, dangerouslySetInnerHTML: { __html: children } });
}
